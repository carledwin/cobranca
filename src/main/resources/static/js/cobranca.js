...
$('#dialogoConfirmacaoExclusaoDespesaModal').on('show.bs.modal', function(event){
	...
	modal.find('.modal-body').html('<strong>Tem certeza que deseja excluir o titulo: <font style= '+ colorBlue +'>'+descricao+'</font><strong>?');
});
